  ...
  return (
    <div className="modal__movie">
        <div className="modal__movie--content">
            <FontAwesomeIcon icon="times" className='modal_exit click'></FontAwesomeIcon> {/* onclick="closeMovieModal() */}
            ...
            <div className="modal__description">
                ...
                <span className='modal__rating'>7.5</span> {/* ADDED RATING */}
                ...
                <div className="modal__meta">
                    ...
                    <span className="modal__runtime">101 MovieInfo</span>
                </div>
